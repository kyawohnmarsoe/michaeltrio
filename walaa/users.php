...
$qs = array();
$users = User::objects()->annotate(array('ticket_count'=>SqlAggregate::COUNT('tickets')));
...
$filter->add(array('cdata__phone2__contains' => $search));
$filter->add(array('cdata__accounttype__contains' => $search));
$filter->add(array('cdata__price__contains' => $search));
$filter->add(array('cdata__address1__contains' => $search));
$filter->add(array('cdata__address2__contains' => $search));
$filter->add(array('cdata__address3__contains' => $search));
$filter->add(array('cdata__notes__contains' => $search));
$filter->add(array('cdata__companytype__contains' => $search));
...
testData(UserForm::getInstance()->getAnswer('accounttype'));
        ...
        <tr>
            ...
            <th><a <?php echo $name_sort; ?> href="users.php?<?php
                echo $qstr; ?>&sort=name"><?php echo __('Name'); ?></a></th>
                 <!-- Kyaw Test Code Start -->
                <th><a <?php echo $default_email__address_sort; ?> href="users.php?<?php
                echo $qstr; ?>&sort=default_email__address"><?php echo __('Email'); ?></a></th>
        ...
        foreach ($users as $U) {
               ...
               <tr id="<?php echo $U['id']; ?>">
                ...
                <td>&nbsp;
                 ...
                 <!-- Kyaw Test Code Start -->
                <td>
                    <a href="http://admin.earthlink.iq/UserManagement.aspx?&ui=<?php echo $U['default_email__address']; ?>" target="_blank">
                    <?php echo $U['default_email__address'] ?>
                    </a>
                </td>
